...
Следуйте файлу ".draftspec/templates/prompts/implement.md".

Команда: `/draftspec.implement [request]`
...
- Scripts для выполнения (запускать через shell):
  - `./.draftspec/scripts/check-implement-ready.sh`
  - `./.draftspec/scripts/list-open-tasks.sh`
