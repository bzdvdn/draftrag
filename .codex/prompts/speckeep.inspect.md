...
Сначала откройте и прочитайте файл ".speckeep/templates/prompts/inspect.md" (обязательно). Затем строго следуйте его разделу "Output expectations", включая финальную строку `Готово к: ...`.
