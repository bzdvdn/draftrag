...
Сначала откройте и прочитайте файл ".speckeep/templates/prompts/tasks.md" (обязательно). Затем строго следуйте его разделу "Output expectations", включая финальную строку `Готово к: ...`.
