...
func TestWeaviateStore_EmbeddingDimensionMismatch(t *testing.T) {
...
func TestWeaviateStore_ChunkValidation(t *testing.T) {
...
func TestWeaviateStore_MetadataMapping(t *testing.T) {
...
func TestWeaviateStore_HybridConfig_Validation(t *testing.T) {
...
func TestWeaviateStore_HybridConfig_InvalidRRFK(t *testing.T) {
	config := domain.HybridConfig{
		UseRRF: true,
		RRFK:   0, // невалидно
	}
...
func TestWeaviateStore_HybridConfig_InvalidSemanticWeight(t *testing.T) {
	config := domain.HybridConfig{
		UseRRF:         false,
...
func TestWeaviateStore_ParentIDFilter(t *testing.T) {
...
func TestWeaviateStore_MetadataFilter(t *testing.T) {
...
func TestWeaviateStore_EmbeddingVector(t *testing.T) {
...
func TestWeaviateStore_RetrievalResult(t *testing.T) {
