...
Сначала откройте и прочитайте файл ".speckeep/templates/prompts/constitution.md" (обязательно). Затем строго следуйте его разделу "Output expectations", включая финальную строку `Готово к: ...` (без замены на «Следующий шаг», без альтернативных фаз, без выдуманных флагов).
...
Используйте этот workflow, когда запрос явно относится к фазе "constitution" или команде /speckeep.constitution.
